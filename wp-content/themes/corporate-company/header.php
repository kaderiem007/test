...
<div id="page" class="site">
    <a class="skip-link screen-reader-text"
       href="#content"><?php esc_html_e('Skip to content', 'corporate-company') ?></a>
                        ...
                        <div class="col-xs-12 col-sm-6">
                            ...
                            {?>
                                <div class="apply-now">
                                    <a href="<?php echo esc_url_raw(  $ample_business_apply_link); ?>"
                                       class="read-more-background" target="_blank" ><?php echo  esc_html($ample_business_apply_button); ?>
                                    </a>
                            ...
                            <div class="header-search">
                                ...
                                <form action="<?php echo esc_url(home_url()) ?>" autocomplete="on" class="top-search">
                                    <input id="search" name="s" value="<?php echo get_search_query(); ?>" type="text" placeholder="<?php  esc_html__('search','corporate-company');?>">
